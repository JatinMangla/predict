...
export const hi: Dict = {
  ...
  // Hindu calendar
  hinduCalendarTitle: "हिंदू पंचांग कैलेंडर",
  lunarMonth: "चंद्र मास",
  vikramSamvat: "विक्रम संवत्",
  sankranti: "संक्रांति",
  todayLabel: "आज",
  moonToday: "इस दिन का चंद्रमा",
  selectDayHint: "किसी भी दिन पर टैप करें — पूरा पंचांग और चंद्रमा देखें।",
  personalCalendarTitle: "मेरी कुंडली कैलेंडर",
  viewPersonalCalendar: "कुंडली अनुसार व्यक्तिगत कैलेंडर",
  generalCalendar: "सामान्य पंचांग",
  taraOfDay: "दिन का ताराबल",
  chandraOfDay: "चंद्रबल",
  fromYourMoonShort: "आपके चंद्र से",
  dayQualityNote: "दिन के रंग इस कुंडली के लिए व्यक्तिगत हैं: हरा = शुभ (तारा+चंद्र बल), पीला = मिश्रित, लाल = सावधानी से कार्य करें।",
  festivalsLabel: "पर्व-त्योहार",
  timingsLabel: "दिन के मुहूर्त",
  rahuKaal: "राहु काल (वर्जित)",
  yamaganda: "यमगण्ड (वर्जित)",
  gulikaKaal: "गुलिक काल (वर्जित)",
  abhijitM: "अभिजीत मुहूर्त (श्रेष्ठ)",
  abhijitSkipped: "बुधवार को अभिजीत मान्य नहीं",
  doToday: "आज शुभ",
  avoidToday: "आज वर्जित",
  ...
  freeCallsLeft: "मुफ़्त AI कॉल आज शेष",
  aiQuotaExhausted: "Gemini की मुफ़्त दैनिक सीमा (Google की वास्तविक सीमा) समाप्त हो गई है। यह अमेरिकी पैसिफ़िक मध्यरात्रि (~दोपहर 12:30 IST) पर रीसेट होती है।",
  quotaNote: "Google की वास्तविक मुफ़्त सीमा (Gemini 2.5 Flash: 250/दिन) के विरुद्ध, इसी डिवाइस से गिना गया।",
